...
export interface TimePickerPeriodSelectorProps {
  period: Period;
...
export const TimePickerPeriodSelect = React.forwardRef<HTMLButtonElement, TimePickerPeriodSelectorProps>(({ period, setPeriod, date, setDate, onLeftFocus, onRightFocus }, ref) => {
